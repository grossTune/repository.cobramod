...
livetv = \
    xbmc.translatePath(os.path.join('special://home/addons/plugin.video.boxportal.1/resources/pic/icon.png'
                       ))
filme = \
    xbmc.translatePath(os.path.join('special://home/addons/plugin.video.boxportal.1/resources/pic/icon.png'
                       ))
...
with urllib.request.urlopen("https://raw.githubusercontent.com/cobramod/repository.cobramod/main/repo/tv/1/live.txt") as url:
    portal = url.read().decode('utf-8')

with urllib.request.urlopen("https://raw.githubusercontent.com/cobramod/repository.cobramod/main/repo/tv/1/user.txt") as url2:
    username = url2.read().decode('utf-8')

with urllib.request.urlopen("https://raw.githubusercontent.com/cobramod/repository.cobramod/main/repo/tv/1/pass.txt") as url3:
...
Guide = \
    xbmc.translatePath(os.path.join('special://home/addons/plugin.video.boxportal.1/resources/catchup'
                       , 'guide.xml'))
GuideLoc = \
    xbmc.translatePath(os.path.join('special://home/addons/plugin.video.boxportal.1/resources/catchup'
                       , 'g'))
...
def addonsettings(url, description):
    if url == 'CC':
        ...
        xbmc.executebuiltin('Runscript("special://home/addons/plugin.video.boxportal.1/resources/modules/speedtest.py")'
                            )
    elif url == 'META':
...
def correctPVR():
    ...
    addon = xbmcaddon.Addon('plugin.video.boxportal.1tPVRtv')
