...
with urllib.request.urlopen("https://raw.githubusercontent.com/cobramod/repository.cobramod/main/repo/tv/2/live.txt") as url:
    portal = url.read().decode('utf-8')

with urllib.request.urlopen("https://raw.githubusercontent.com/cobramod/repository.cobramod/main/repo/tv/2/user.txt") as url2:
    username = url2.read().decode('utf-8')

with urllib.request.urlopen("https://raw.githubusercontent.com/cobramod/repository.cobramod/main/repo/tv/2/pass.txt") as url3:
