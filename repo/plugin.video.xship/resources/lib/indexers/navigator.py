...
class navigator:
    def root(self):
        #dirty fix urlresolver - create setting.xml
        import urlresolver
...
# TODO vote_count vote_average popularity revenue
    ...
    def tools(self):
        ...
        self.addDirectoryItem("[B]UrlResolver[/B]: EINSTELLUNGEN", 'urlResolverSettings', 'urlresolver.png', 'DefaultAddonProgram.png', isFolder=False)
