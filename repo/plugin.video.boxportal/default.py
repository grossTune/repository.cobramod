...
addon_id = 'plugin.video.boxportal'
...
with urllib.request.urlopen("http://codi.maccoderz.de/wizard/tv/live.txt") as url:
    portal = url.read().decode('utf-8')                     

with urllib.request.urlopen("http://codi.maccoderz.de/wizard/tv/user.txt") as url2:
    username = url2.read().decode('utf-8')
    
with urllib.request.urlopen("http://codi.maccoderz.de/wizard/tv/pass.txt") as url3:
