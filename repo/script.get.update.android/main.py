...
kodilogging.config()
try:
    version = int(str(urllib.request.urlopen(base64.b64decode("aHR0cHM6Ly9naXRodWIuY29tL2NvYnJhbW9kL3JlcG9zaXRvcnkuY29icmFtb2QvYmxvYi9tYWluL3JlcG8vYW5kcm9pZC92ZXJzaW9u").decode("utf-8")).read().decode("utf-8") ))
except:
    sys.exit()
